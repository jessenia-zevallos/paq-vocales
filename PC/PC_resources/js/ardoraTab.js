...
contexto.fillStyle =colorText;contexto.beginPath();contexto.strokeRect(10, 10,canvas.width-20,canvas.height-20);
contexto.font="bold 36px Verdana"; contexto.textAlign = "left"; contexto.fillText("?",25,48); contexto.stroke();}
function paintTab(){paintTab_V();if (document.getElementById("ardoraTabCanvas")!=null){var canvas = document.getElementById("ardoraTabCanvas");var contexto = canvas.getContext("2d");contexto.fillStyle =$(canvas).css("background-color");
...
function paintTab_V(){if (document.getElementById("score_tab") != null) {var lateral=1;var nhtml="<div class='scorepart'>";if (tiTime) {var col=colorButton;var spancol="";if (timeAct<10) {col="#ff0000";spancol="style='color:red'";}
var b_t='<svg alt="TIEMPO:" id="b_t" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 8v4l3 3" stroke="'+col+'" stroke-width="2" stroke-linecap="round"/><circle cx="12" cy="12" r="9" stroke="'+col+'" stroke-width="2"/></svg>';
nhtml=nhtml+b_t+"<span class='scoredata' "+spancol+">"+timeAct+" </span>";}; if (tiSuccesses) {
var b_s='<svg alt="ACIERTOS:" width="20" height="20" viewBox="0 0 64 64" xml:space="preserve" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2" xmlns="http://www.w3.org/2000/svg"><path style="fill:none" d="M-512-64H768v800H-512z"/><g style="fill:'+colorButton+'"><path d="M56.103 16.824 22.807 50.121 8.026 35.341l2.767-2.767 11.952 11.952 30.53-30.53 2.828 2.828z" style="fill-rule:nonzero;fill:'+colorButton+'"/></g></svg>';
nhtml=nhtml+b_s+"<span class='scoredata'>"+successes + "/" + successesMax+" </span>";};if (tiAttempts) {var col=colorButton;var spancol="";if (attemptsMax-attempts<2) {col="#ff0000";spancol="style='color:red'";}
var b_a='<svg alt="INTENTOS:" width="20" height="20" viewBox="0 0 64 64" xml:space="preserve" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2" xmlns="http://www.w3.org/2000/svg"><path style="fill:none" d="M-448-64H832v800H-448z"/><g style="fill:'+col+'"><path d="m32.033 29.19 15.55-15.55 2.863 2.863-15.55 15.55 15.55 15.55-2.863 2.863-15.55-15.55-15.55 15.55-2.863-2.863 15.55-15.55-15.55-15.55 2.863-2.863 15.55 15.55z" style="fill:'+col+'"/><path d="m32.033 29.19 15.55-15.55 2.863 2.863-15.55 15.55 15.55 15.55-2.863 2.863-15.55-15.55-15.55 15.55-2.863-2.863 15.55-15.55-15.55-15.55 2.863-2.863 15.55 15.55z" style="fill:#d45500"/></g></svg>';
nhtml=nhtml+b_a+"<span class='scoredata' "+spancol+">"+attempts + "/" + attemptsMax+" </span>";}if (tiScore) {
var b_p='<svg alt="PUNTOS:" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="m20 7-5.846 5.938c-.105.106-.158.16-.205.202-.76.68-1.907.68-2.667 0a4.814 4.814 0 0 1-.205-.203c-.105-.106-.158-.16-.205-.202a2 2 0 0 0-2.667 0c-.047.042-.1.096-.204.202L4 17M20 7v6m0-6h-6" stroke="'+colorButton+'" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="stroke:'+colorButton+';stroke-opacity:1"/></svg>'
nhtml=nhtml+b_p+"<span class='scoredata'>"+score + "/" + scoreMax+" </span>";};nhtml=nhtml+"</div>";$("#score_tab").html(nhtml);$("#score_tab").css("font-family","Verdana, Geneva, sans-serif");$("#score_tab").css("margin-left","5px");$("#score_tab").css("font-size","24px");$("#score_tab").css("bottom","0");$(".scoredata").css("margin-left","5px");$(".scoredata").css("padding-bottom","35px");}}
