...
$("#botonPechar").keydown(function(e){if (e.which!=9){PechaVentana();}});$("#suggestPost").keydown(function(e){if (e.which!=9){$("#suggestPost").click();}})
   ...
   menuLateral='';
   menuActividades='<li><h2></h2><table width="130" border="0"><ul><tr><td width="26"><a href="javascript:irA(0)" title="ACT 1">1</a></td><td width="26"><a href="javascript:irA(1)" title="ACT2">2</a></td></tr></ul></table></li>';
...
taboaContidos[0]=new act("ACT 1","ACT 1","","<object class='ardobject' width='100%' height='420' type='text/html' data='ALBUN/ALBUN.htm'></object>",true,"",true,false,false);
taboaContidos[1]=new act("ACT2","ACT2","","<object class='ardobject' width='100%' height='420' type='text/html' data='PC/PC.htm'></object>",true,"",true,false,false);
